...
eda, pca, random_forest_regressor, astro_process: This was run on a native
machine. In general they need scikit-learn v.0.24.2 and numpy v.1.20.3,
and astro_process needs astropy v.4.3.1 to run properly. They are meant to
run on command line after some slight augmentation, e.g. python <filename.py>
